        ...
        <div class="col-lg-12">
          <div class="ibox float-e-margins">
               <div class="ibox-title">
                 <h5><i class="fa fa-edit"></i> <CakePHPBakeOpenTag= __('<?= Inflector::humanize($actionEsp) ?> <?= $singularHumanName ?>') CakePHPBakeCloseTag></h5>                    
               </div>               
               ...
               <div class="row">
                <div class="col-md-12">
                  <div class="btn-toolbar" role="toolbar">
                    ...
                    ?>
                    <div class="btn-group pull-right">
                           <CakePHPBakeOpenTag= $this->Html->link(__('<i class="fa fa-list-ul"></i> '), ['controller' => '<?= $details['controller'] ?>', 'action' => 'index'],['class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Lista de <?= $this->_pluralHumanName($alias) ?>']) CakePHPBakeCloseTag>
                           <CakePHPBakeOpenTag= $this->Html->link(__('<i class="fa fa-plus-circle"></i> '), ['controller' => '<?= $details['controller'] ?>', 'action' => 'add'],['class' => 'btn btn-default','escape'=>false,'rel'=>'tooltip', 'title'=>'Nuevo <?= $this->_singularHumanName($alias) ?> ']) CakePHPBakeCloseTag>
                       </div>
                    <?php
        ...
        CakePHPBakeCloseTag>
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-9">                    
                        <CakePHPBakeOpenTagphp echo $this->Form->button(__('<i class="fa fa-check-circle"></i> Guardar'),array('type'=>'submit','class'=>'btn btn-primary','div'=>false,'escape'=>false));CakePHPBakeCloseTag>
                        <CakePHPBakeOpenTagphp echo $this->Html->link(__('<i class="fa fa-times-circle"></i> Cancelar'),array('action' => 'index'),array('class'=>'btn  btn-default','escape'=>false,'role'=>'button'));CakePHPBakeCloseTag>
                  </div>
               </div>
             </fieldset>                                                 
