...
class ReportesController extends AppController
{
    ...
    public function index()
    {
        ...
        $serviciosUsuarios = $this->Servicios->find('all',
                                                ['contain'=>['CoUsers'],
                                                'fields'=>['Servicios.co_user_id','CoUsers.nombre'],
                                                'conditions'=>['Servicios.fecha_solicitud >='=>$inicio,'Servicios.fecha_solicitud <='=>$fin],        
        ...
        $serviciosTipo = $this->Servicios->find('all',
                                                ['contain'=>['TipoServicios'],
                                                'fields'=>['Servicios.tipo_servicio_id','TipoServicios.descripcion'],
                                                'conditions'=>['Servicios.fecha_solicitud >='=>$inicio,'Servicios.fecha_solicitud <='=>$fin],
                                                'group'=>['Servicios.tipo_servicio_id']])->select(['Servicios.tipo_servicio_id',
                                                                                                        'count' => $this->Servicios->find()->func()->count('*')])->order(['count'=>'ASC']);  
        ...
        $this->set(compact('servicios','inicio','fin','serviciosArea','serviciosUsuarios','serviciosEstatus','serviciosTipo'));
